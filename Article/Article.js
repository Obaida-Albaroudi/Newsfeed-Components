...
data.forEach(section => {
  articles.appendChild(tab(section.title, section.date, section.firstParagraph, section.secondParagraph, section.thirdParagraph))

});

function tab(title, date, first, second, third) {
